...
function Portfolio() {
  ...
  return (
    <>
          <NextSeo
        title="Portfolio - Our Successful Projects | Trimsel"
        description="Explore Trimsel's portfolio of successful projects in web development, mobile apps, DevOps, and cloud solutions."
        canonical="https://trimsel.com/portfolio"
        openGraph={{
          title: "Portfolio - Our Successful Projects | Trimsel",
          description: "Explore Trimsel's portfolio of successful projects in web development, mobile apps, DevOps, and cloud solutions.",
          url: "https://trimsel.com/portfolio",
          images: [
            { url: "https://trimsel.com/images/portfolio-thumbnail.jpg", width: 1200, height: 630, alt: "Portfolio Thumbnail" },
          ],
        }}
        twitter={{
