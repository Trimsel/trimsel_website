...
export default function Portfolio() {
  return (
    <div className="relative w-full h-[820px] overflow-hidden">
      ...
      {/* Content Overlay */}
      <div className="absolute inset-0 px-8 mt-20">
        <h1
        ...
        <p
          className={`text-lg sm:text-xl font-bold text-[#0D55A1] mb-4 ${manropeFont.className}`}
        >
          MOCIAL - ALL IN ONE SPECIAL PLATFORM APP
        </p>

        <p
          className={`text-sm sm:text-base text-black leading-relaxed max-w-lg mb-6 ${manropeFont.className}`}
        >
          We built a robust social media app for the client that can take and handle traffic of millions of people to ensure they can scale with ease.
        </p>
